...
return (
    <div className="container d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '80vh' }}>
        ...
        <div className="d-flex justify-content-between align-items-center mb-4" style={{ fontSize: '14px' }}>
            ...
            <Link to="/login" className="text-dark text-decoration-none fw-medium">
    Login here
    </Link>
        </div>
        <div className="text-center">
            <button type="submit" className="btn btn-dark rounded-0 px-4 py-2 text-uppercase fw-medium">
            Sign Up
            </button>
        </div>
    </form>
